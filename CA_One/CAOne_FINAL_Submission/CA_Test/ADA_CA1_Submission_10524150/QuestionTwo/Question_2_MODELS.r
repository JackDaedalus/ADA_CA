...
## Question Two - R program performing discrete and continuous probability modelling on attributes 
...
#####################################################################################################
# Continuous Variable in Pima Indian dataset - BMI
#####################################################################################################
...
# 1 - Use Normal Model to quantify uncertainty of the data. BMI is a continuous variable and it would be  
...
#####################################################################################################
# Continuous Variable in Pima Indian dataset - DiabetesPedigreeFunction
#####################################################################################################
...
range(xDBF)
# 1 - Use Exponential Model to quantify uncertainty of the data because the data is continuous and positive.
...
# For consistency of result for this question I used the 'set.seed(3243)' command and parameter. This ensures 
